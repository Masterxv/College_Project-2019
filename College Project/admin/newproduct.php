...
if($_SERVER['REQUEST_METHOD'] =='POST'){
   ...
   //echo ($product_title);
    ...
    $insertdata = "INSERT into product_new()values('$product_title','$can_compare','$product_lowest_price','$product_link','$product_id','$product_category','$product_sub_category',    $product_rating,'$product_image','new')";
