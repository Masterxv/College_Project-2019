...
$flipkart = new \clusterdev\Flipkart("Rajbharru", "f99102f54baa440abda4a007d648d005", "json");
...
foreach ($list as $key => $data) {
	...
	print_r('<a href="?url='.base64_encode($data['availableVariants']['v0.1.0']['get']).'">View Products &raquo;</a>');
	//echo ($data);
}
